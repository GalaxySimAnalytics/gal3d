...
def vector_length3d(np.ndarray[np.float64_t, ndim=2] pos):
...
@cython.boundscheck(False)
@cython.wraparound(False)
def unit_vector3d(np.ndarray[np.float64_t, ndim=2] pos):
    cdef int n = pos.shape[0]
...
def f_ellipsoid(floating a, floating b, floating c, np.ndarray[np.float64_t, ndim=2] pos):
    cdef int n = pos.shape[0]
...
def f_ellipsoid_jacobian(floating a, floating b, floating c, np.ndarray[np.float64_t, ndim=2] pos):
    '''
...
def IntersectRaysEllipsoid(floating a, floating b, floating c, np.ndarray[np.float64_t, ndim=2] pos):
    cdef int n = pos.shape[0]
...
def f_ray_ellipsoid(floating a, floating b, floating c, np.ndarray[np.float64_t, ndim=2] pos):
    cdef int n = pos.shape[0]
...
def IntersectLinesEllipsoid(floating a, floating b, floating c, 
