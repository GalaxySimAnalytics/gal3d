...
class MyPchipInterpolator:
    ...
    def __init__(self, x: Any, y: Any, extrapolate: str | bool = "const") -> None: ...
    @overload
    def __call__(self, x: float, nu: int = 0, extrapolate: str | bool | None = None) -> float: ...
    @overload
    def __call__(self, x: np.ndarray, nu: int = 0, extrapolate: str | bool | None = None) -> np.ndarray: ...
    @overload
    def solve(self, y: float, discontinuity: bool = True, extrapolate: bool = True) -> float | np.ndarray: ...
    @overload
    def solve(self, y: np.ndarray, discontinuity: bool = True, extrapolate: bool = True) -> list[float | np.ndarray]: ...
...
class LU_Mono:
    ...
    def __init__(self, x: np.ndarray, y: np.ndarray, is_decreasing: bool = True, resample_order: int = 0, **kwargs:Any) -> None: ...
    @property
