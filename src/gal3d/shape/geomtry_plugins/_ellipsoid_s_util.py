...
__all__=["f_shaped_ellipsoid","f_shaped_ellipsoid_jacobian","f_shaped_ellipsoids",
         "IntersectRaysEllipsoid_S", "f_ray_shaped_ellipsoid", "IntersectLinesEllipsoid_S"]


@jit(float64[:](float64,float64,float64,float64,float64,float64,float64[:,:]),nogil=True,parallel=True,fastmath=True,cache=True )
...
@jit(types.Tuple((float64[:],float64[:],float64[:],float64[:],float64[:],float64[:],float64[:],float64[:],float64[:]))
     (float64,float64,float64,float64,float64,float64,float64[:,:]),nogil=True,parallel=True,fastmath=True,cache=True )
...
@jit(types.Tuple((float64,float64))(float64[:],float64[:],float64,float64,float64,float64,float64,float64,float64,int32,float64,float64),
...
@jit(float64[:,:](float64,float64,float64,float64,float64,float64,float64[:,:],float64[:,:],int32),nogil=True,parallel=True,fastmath=True,cache=True)
