...
from ..field.spherical_field.util import fibonacci_sampling, vector_length3d
...
class Structure_3D:
    ...
    def quick_call(self, *args,pos,**kwargs):
        ...
        **kwargs : dict
        ...
        if kwargs:
            try:
                coord_pa = {i:kwargs[i] for i in self._coordinate_quick_params}
                shape_pa = {i:kwargs[i] for i in self._shape_quick_params}
            except:
