...
def RotateAndShift(pos, matrix, pc):
    """
    Perform rotation followed by translation in a single operation.
    ...
    -------
    numpy.ndarray
        Rotated and shifted positions
    """
    # Combine operations to eliminate intermediate array creation
    return np.matmul(pos, matrix.T) - pc
