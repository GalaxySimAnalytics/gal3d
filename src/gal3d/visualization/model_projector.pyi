...
class ModelProjectorBase:
    ...
    def image(
        ...
        rotation: None | numpy.ndarray[typing.Any, numpy.dtype[numpy.float64]] = None,
        **kwargs,
    ) -> None: ...
    def _image(
        self,
    ...
    def image_xz(
        self, x_range, y_range, nbins: int = 100, z_range: Sequence = (-20, 20)
    ) -> None: ...
    def image_yz(
        self, x_range, y_range, nbins: int = 100, z_range: Sequence = (-20, 20)
    ) -> None: ...
...
class ModelProjector:
    ...
    @overload
    def get_plugin(
        plugin: Literal['ProjectorLineIntegration'],
    ) -> Type[ProjectorLineIntegration]: ...
    @staticmethod
    @overload
